...
{
    private static final String AUTHORIZE_BASE_URL = "https://developers.tradeking.com/oauth/authorize";
    ...
    public String getAuthorizationUrl(OAuth1AccessToken requestToken)
    {
